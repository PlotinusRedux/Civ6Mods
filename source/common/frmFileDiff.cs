...
{
    public partial class frmFileDiff : Form
    {
        ...
        private ViewType m_eView = ViewType.Unified;
        ...
        public frmFileDiff(string strFile1, string strFile2, ViewType eView = ViewType.Unified) : this()
        {
            View = eView;
            ...
            Text = "Difference between " + strFile1Title + " and " + strFile2Title;
